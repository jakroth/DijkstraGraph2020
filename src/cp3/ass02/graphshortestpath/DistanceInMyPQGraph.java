...
public class DistanceInMyPQGraph extends Graph{

    /**
     * Priority queue for quick access to smallest distance
     */
    private MyPriorityQueue distances;
    /**
     * The edges variable holds the number of edges + nodes in an incoming Graph, obtained directly from the GraphML file.
     * The number of distance variables should never exceed the number of edges in the graph.
     * Because I initialise a distance variable to 100000 for each vertex at the beginning, I need to also add 1 spot for every Vertex
     */
    public int edges;

    /**
     * Constructor for MyPriorityQueueGraph
